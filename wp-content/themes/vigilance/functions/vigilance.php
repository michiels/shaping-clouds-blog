<?php $copyright_name = get_option('V_copyright_name'); ?>
<?php/*	
            ...
            Copyright 2008 - 2009 Jestro LLC  
            
*/?>
    <p class="right">Copyright <?php echo date('Y') ?> <?php echo wp_filter_post_kses($copyright_name); ?></p>
